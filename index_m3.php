        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="index_m3.php">Thai Drama Update</a></li>
...
<div class="span9">
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
           ...
           <div class="text-center"><h3>Thai Drama Update!</h3></div>
...
$context  = stream_context_create($opts);
    ...
    $cache_file = "cache/m3_index_u_$page.cache";
...
<p align="center"><a href="index_m3.php?page=<?=$page2;?>" class="btn btn-primary" data-loading-text="loading..." type="button"> Load More... </button></a>
 </div> <!-- /container -->
