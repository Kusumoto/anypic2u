...
<center><div class="fb-like-box" data-href="https://www.facebook.com/zxpic" data-width="500" data-height="210" data-show-faces="true" data-stream="false" data-show-border="false" data-header="true"></div></center>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="allmovies_m6.php">Browse Cartoon Live!</a></li>
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
           ...
           <div class="text-center"><h3>Browse Cartoon Live!</h3></div>
          ...
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='allmovies_m6.php?page=$page3'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='allmovies_m6.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='allmovies_m6.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='allmovies_m6.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='allmovies_m6.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
    </p>
         <table class="table table-bordered">
<?php
     $xmlUrl = "http://cartoonlive.serviceseries.com/CartoonHandler.ashx?type=serie&pid=$page&ps=20";   

$cache_file = "cache/m6_index_d_$page.cache";
...
<div id="ViewM1_<?=$p;?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      <h3 id="myModalLabel"><?=$arrXml['item'][$p]['entitle'];?><?php if(strlen(strstr($_SERVER['HTTP_USER_AGENT'],"iPhone")) >= 1 || strlen(strstr($_SERVER['HTTP_USER_AGENT'],"Windows Phone"))){ // if not firefox
  ?><a href="getlink.php?type=m6&id=<?=$arrXml['item'][$p]['id'];?>" class="btn btn-primary" target="_BLANK"><i class="icon-film"></i> รับชมการ์ตูนเรื่องนี้</a><?php
} ?></h3>
        </div>
