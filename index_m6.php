        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="index_m6.php">Cartoon Live! Update</a></li>
...
<div class="span9">
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
           ...
           <div class="text-center"><h3>Cartoon Live Update!</h3></div>
...
<?php 
    ...
    $xmlUrl = "http://cartoonlive.serviceseries.com/CartoonHandler.ashx?type=serienews&ps=$page&pid=0&version=iphone";   
    $cache_file = "cache/m6_index_u_$page.cache";
...
if ($vip == 1 || $vip == 2) {
    echo ' <td><a href="#" onclick="MM_openBrWindow(\'http://anypicplayer.eu5.org/mini.php?url='.base64_encode(bin2hex(base64_encode($arrXml['item'][$i]['link']))).'&pic=getpostermv_m6.php?id='.$pic.'&title='.$arrXml['item'][$i]['seriename'].'&part='.$arrXml['item'][$i]['partname'].'\',\'\',\'status=yes,width=700,height=500\')" class="btn btn-inverse">ดูตอนนี้</a> <a href="getlink.php?type=m6&id='.$arrXml['item'][$i]['serieid'].'" class="btn btn-inverse" target="_BLANK">ดูตอนทั้งหมด</a>';
    } else {
      echo ' <td><a href="javascript:window.alert(\'กรุณาเข้าสู่ระบบด้วย Facebook\')" class="btn btn-inverse">ดูตอนนี้</a> <a href="getlink.php?type=m6&id='.$arrXml['item'][$i]['serieid'].'" class="btn btn-inverse" target="_BLANK">ดูตอนทั้งหมด</a>';
    } 
    $i++;
}
}
...
<p align="center"><a href="index_m6.php?page=<?=$page2;?>" class="btn btn-primary" data-loading-text="loading..." type="button"> Load More... </button></a>
 </div> <!-- /container -->
