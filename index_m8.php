...
<center><div class="fb-like-box" data-href="https://www.facebook.com/zxpic" data-width="500" data-height="210" data-show-faces="true" data-stream="false" data-show-border="false" data-header="true"></div></center>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="index_m8.php">Browse Asian Movies</a></li>
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
           ...
           <div class="text-center"><h3>Asian Movies Update!</h3></div>
           <div class="text-right">
               <form class="form-search" action="search_m8.php" method="POST">
          ...
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='index_m8.php?page=$page3'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='index_m1.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='index_m8.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='index_m8.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='index_m8.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
    </p>
...
$opts = array('http' =>
    array(
        ...
        'header'  => //'Content-type: application/x-www-form-urlencoded 
                      'User-Agent: com.comicfcapp.sianfciphone/1.0 (unknown, iPhone OS 6.1.3, iPod touch, Scale/2.000000)',
       // 'proxy' => 'tcp://109.205.117.130:8080',
        'content' => $postdata        
    )
);
$context  = stream_context_create($opts);
$cache_file = "cache/m8_index_d_$page.cache";
...
?> 
    ...
    <p align="center">
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='index_m8.php?page=$page3'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='index_m8.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='index_m8.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='index_m8.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='index_m8.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
