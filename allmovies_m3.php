...
<center><div class="fb-like-box" data-href="https://www.facebook.com/zxpic" data-width="500" data-height="210" data-show-faces="true" data-stream="false" data-show-border="false" data-header="true"></div></center>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="allmovies_m3.php">Browse Thai Drama</a></li>
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
           ...
           <div class="text-center"><h3>Browse Thai Drama</h3></div>
           <div class="text-right">
            ...
            <hr>
              <center><a href="allmovies_m3.php">แสดงทั้งหมด</a> <a href="allmovies_m3.php?ch=1"><img src="img/tv3.png" height="50" width="50"\></a> <a href="allmovies_m3.php?ch=2"><img src="img/tv5.png" height="50" width="50"\></a> <a href="allmovies_m3.php?ch=3"><img src="img/tv7.png" height="50" width="50"\></a> <a href="allmovies_m3.php?ch=4"><img src="img/tv9.png" height="50" width="50"\></a> <a href="allmovies_m3.php?ch=5">ช่องอื่นๆ</a></center>
            <hr>
          <p align="center">
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='allmovies_m3.php?page=$page3&ch=$ch'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='allmovies_m3.php?ch=$ch'> <i class='icon-home'></i> Home</a> <a class='btn' href='allmovies_m3.php?page=$page2&ch=$ch'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='allmovies_m3.php?ch=$ch'> <i class='icon-home'></i> Home</a> <a class='btn' href='allmovies_m3.php?page=$page2&ch=$ch'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
    </p>
...
$cache_file = "cache/m3_index_d_$page_$ch.cache";
...
<div id="ViewM1_<?=$p;?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  ?><a href="getlink.php?type=m3&id=<?=$arrXml['item'][$p]['id'];?>" class="btn btn-primary" target="_BLANK"><i class="icon-film"></i> รับชมละครเรื่องนี้</a><?php
} ?></h3> 
        </div>
  ...
  <?php }else{ ?>
   ...
   <?php     }  ?>
      ...
      <a href="getlink.php?type=m3&id=<?=$arrXml['item'][$p]['id'];?>" class="btn btn-primary" target="_BLANK"><i class="icon-film"></i> รับชมละครเรื่องนี้</a>
