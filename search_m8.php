...
<center><div class="fb-like-box" data-href="https://www.facebook.com/zxpic" data-width="500" data-height="210" data-show-faces="true" data-stream="false" data-show-border="false" data-header="true"></div></center>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="search_m8.php">Search Asian Movies</a></li>
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
            ...
            <div class="text-center"><h3>Asian Movies Search!</h3></div>
           <div class="text-right">
               <form class="form-search" method="POST" action="search_m8.php">
          ...
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='search_m8.php?page=$page3&keyword=$keyword'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='search_m8.php?keyword=$keyword'> <i class='icon-home'></i> Home</a> <a class='btn' href='search_m8.php?page=$page2&keyword=$keyword'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='search_m8.php?keyword=$keyword'> <i class='icon-home'></i> Home</a> <a class='btn' href='search_m8.php?page=$page2&keyword=$keyword'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
    </p>
...
$opts = array('http' =>
    array(
        'method'  => 'POST',
        'header'  => 'User-Agent: com.comicfcapp.sianfciphone/1.0 (unknown, iPhone OS 6.1.3, iPod touch, Scale/2.000000)'.
...
$context  = stream_context_create($opts);
  ...
  while ($i < 3) {
     ...
     echo '<tr>';
     for ($y = 0;$y < 4; $y++) {
     echo '<th><a href="#" data-toggle="modal" data-target="#ViewM1_'.$z.'" ><img src="getpostermv_m8.php?id='.$arrXml[$z]['PictureName'].' " width="200" height="200"></br>'.$arrXml[$z]['EnTitle'].'</a></th>';
   $z++;
   }
echo "</tr>";
 $i++;
...
?> 
    ...
    <p align="center">
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='search_m8.php?page=$page3&keyword=$keyword'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='search_m1.php?keyword=$keyword'> <i class='icon-home'></i> Home</a> <a class='btn' href='search_m8.php?page=$page2&keyword=$keyword'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='search_m8.php?keyword=$keyword'> <i class='icon-home'></i> Home</a> <a class='btn' href='search_m8.php?page=$page2&keyword=$keyword'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
