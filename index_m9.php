        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="index_m9.php">SitCom Update</a></li>
...
<div class="span9">
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
           ...
           <div class="text-center"><h3>Sitcom Update!</h3></div>
...
$context  = stream_context_create($opts);
    ...
    $cache_file = "cache/m9_index_u_$page.cache";
...
if (!empty($_SESSION['ses_fbid'])) {
    echo ' <td><a href="#" onclick="MM_openBrWindow(\'http://anypicplayer.eu5.org/mini.php?url='.base64_encode(bin2hex(base64_encode($arrXml[$i]['Link']))).'&pic=getpostermv_m9.php?id='.$pic.'&title='.$arrXml[$i]['SerieTitle'].'&part='.$arrXml[$i]['PartName'].'\',\'\',\'status=yes,width=700,height=500\')" class="btn btn-inverse">ดูตอนนี้</a> <a href="getlink.php?type=m9&id='.$arrXml[$i]['SerieID'].'" class="btn btn-inverse" target="_BLANK">ดูตอนทั้งหมด</a>';
    } else {
...
<p align="center"><a href="index_m9.php?page=<?=$page2;?>" class="btn btn-primary" data-loading-text="loading..." type="button"> Load More... </button></a>
 </div> <!-- /container -->
