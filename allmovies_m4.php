...
<center><div class="fb-like-box" data-href="https://www.facebook.com/zxpic" data-width="500" data-height="210" data-show-faces="true" data-stream="false" data-show-border="false" data-header="true"></div></center>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="allmovies_m4.php">Browse International Series</a></li>
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
           ...
           <div class="text-center"><h3>Browse International Series</h3></div>
           <div class="text-right">
               <form class="form-search" action="search_m4.php" method="POST">
          ...
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='allmovies_m4.php?page=$page3'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='allmovies_m4.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='allmovies_m4.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='allmovies_m4.php'> <i class='icon-home'></i> Home</a> <a class='btn' href='allmovies_m4.php?page=$page2'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
    </p>
...
$cache_file = "cache/m4_index_d_$page.cache";
