...
header("Location: index.php");
    ...
    if (empty($keyword))
        header("Location: allmovies_m5.php");
...
<center><div class="fb-like-box" data-href="https://www.facebook.com/zxpic" data-width="500" data-height="210" data-show-faces="true" data-stream="false" data-show-border="false" data-header="true"></div></center>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="search_m5.php">Search Korea Series</a></li>
  ...
  <p><img src='img/20-0.gif' border='0'>  <strong>หน้านี้จะใช้เวลาโหลดสักครู่นะครับ โปรดรอจนกว่าหน้านี้จะโหลดเสร็จ</strong></p>
            ...
            <div class="text-center"><h3>Search Korea Series!</h3></div>
           <div class="text-right">
               <form class="form-search" method="POST" action="search_m5.php">
          ...
          <?php
          if ($page != 0) {
             echo "<a class='btn' href='search_m5.php?page=$page3&keyword=$keyword'> <i class='icon-arrow-left'></i> Back</a> <a class='btn btn-primary' href='search_m5.php?keyword=$keyword'> <i class='icon-home'></i> Home</a> <a class='btn' href='search_m5.php?page=$page2&keyword=$keyword'>Next <i class='icon-arrow-right'></i></a>";
             }else{
             echo "<a class='btn btn-primary' href='search_m5.php?keyword=$keyword'> <i class='icon-home'></i> Home</a> <a class='btn' href='search_m5.php?page=$page2&keyword=$keyword'>Next <i class='icon-arrow-right'></i></a>";
         } 
         ?>
    </p>
